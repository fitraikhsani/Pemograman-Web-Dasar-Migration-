...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Bulan Mei 2024 pada 10.16
...
(5, '2024_05_18_041320_create_prodis_table', 1),
(6, '2024_05_18_062213_create_mata_kuliahs_table', 1),
(7, '2024_05_18_071735_create_mahasiswas_table', 1),
(8, '2024_05_24_072117_create_jadwal_mahasiswas_table', 1);
...
ALTER TABLE `jadwal_mahasiswas`
  ADD KEY `jadwal_mahasiswas_prodi_id_foreign` (`prodi_id`),
...
ALTER TABLE `mata_kuliahs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `mata_kuliahs_mata_kuliah_unique` (`mata_kuliah`);
...
ALTER TABLE `prodis`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `prodis_nama_prodi_unique` (`nama_prodi`);
...
--
ALTER TABLE `jadwal_mahasiswas`
  ADD CONSTRAINT `jadwal_mahasiswas_mahasiswa_id_foreign` FOREIGN KEY (`mahasiswa_id`) REFERENCES `mahasiswas` (`id`),
  ADD CONSTRAINT `jadwal_mahasiswas_mata_kuliah_id_foreign` FOREIGN KEY (`mata_kuliah_id`) REFERENCES `mata_kuliahs` (`id`),
  ADD CONSTRAINT `jadwal_mahasiswas_prodi_id_foreign` FOREIGN KEY (`prodi_id`) REFERENCES `prodis` (`id`);
COMMIT;
